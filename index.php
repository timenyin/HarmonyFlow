...
<head>
  <?php include('includes/front_navbar.php') ?>
</head>
...
<body style="--phoenix-scroll-margin-top: 1.2rem;">
  ...
  <main class="main" id="top">
    <div class="bg-body-emphasis sticky-top" data-navbar-shadow-on-scroll="data-navbar-shadow-on-scroll">
      <nav class="navbar navbar-expand-lg container-small px-3 px-lg-7 px-xxl-3"><a
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <!-- End of Righ side Details   -->


          <!-- Regular menu/ Dropdown  -->
          <ul class="navbar-nav travel-nav-top me-auto" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold dropdown-toggle " href="#!"
                role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                aria-haspopup="true" aria-expanded="false">Features</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                <li><a class="dropdown-item" href="../hotel/customer/homepage.html">Homepage</a></li>
                <li><a class="dropdown-item" href="../hotel/customer/hotel-details.html">Hotel
                    Details</a></li>
                <li><a class="dropdown-item" href="../hotel/customer/hotel-compare.html">Hotel
                    Compare</a></li>
                <li><a class="dropdown-item" href="../hotel/customer/checkout.html">Check out</a></li>
                <li><a class="dropdown-item" href="../hotel/customer/payment.html">Payment</a></li>
                <li><a class="dropdown-item" href="../hotel/customer/gallery.html">Gallery</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold dropdown-toggle text-primary"
                href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                aria-haspopup="true" aria-expanded="false">Use Cases</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
            ...
            <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold  " href="#!" role="button"
                ...
                aria-expanded="false">Event</a></li>
            <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold  " href="#!" role="button"
                data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true"
                aria-expanded="false">Package</a></li>

            <!-- Mega DropDown Menu -->
            <div class="dropdown ms-3 d-none d-sm-block"><button
                class="btn text-body ps-0 pe-5 text-nowrap dropdown-toggle dropdown-caret-none fs-8 fw-bold"
                    ...
                    <div class="row gx-7 gy-5 mb-5">
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="pocket"
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="home"
                            style="stroke-width:3;"></span>
                          <h6 class="text-body-highlight mb-0 text-nowrap">Home &amp; Gardan
                          </h6>
                        </div>
                        <div class="ms-n2"><a
                            class="text-body-emphasis d-block mb-1 text-decoration-none bg-body-highlight-hover px-2 py-1 rounded-2"
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="globe"
                            style="stroke-width:3;"></span>
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="monitor"
                            style="stroke-width:3;"></span>
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="truck"
                            style="stroke-width:3;"></span>
                          <h6 class="text-body-highlight mb-0 text-nowrap">Auto Parts &amp;
                            Accessories</h6>
                        </div>
                        <div class="ms-n2"><a
                            class="text-body-emphasis d-block mb-1 text-decoration-none bg-body-highlight-hover px-2 py-1 rounded-2"
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="codesandbox"
                            style="stroke-width:3;"></span>
                          <h6 class="text-body-highlight mb-0 text-nowrap">Toys &amp; Hobbies
                          </h6>
                        </div>
                        <div class="ms-n2"><a
                            class="text-body-emphasis d-block mb-1 text-decoration-none bg-body-highlight-hover px-2 py-1 rounded-2"
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="watch"
                            style="stroke-width:3;"></span>
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="music"
                            style="stroke-width:3;"></span>
                          <h6 class="text-body-highlight mb-0 text-nowrap">Musical Instruments
                            &amp; Gear</h6>
                        </div>
                        <div class="ms-n2"><a
                            class="text-body-emphasis d-block mb-1 text-decoration-none bg-body-highlight-hover px-2 py-1 rounded-2"
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        <div class="d-flex align-items-center mb-3"><span
                            class="text-primary me-2" data-feather="grid"
                            style="stroke-width:3;"></span>
                          <h6 class="text-body-highlight mb-0 text-nowrap">Other Categories
                          </h6>
                        </div>
                        <div class="ms-n2"><a
                            class="text-body-emphasis d-block mb-1 text-decoration-none bg-body-highlight-hover px-2 py-1 rounded-2"
          ...
          <div class="d-grid d-lg-flex align-items-center">
            ...
            <a class="btn btn-link text-body order-1 order-lg-0 ps-4 me-lg-2"
              href="authentication/simple/sign-in.html">Sign in</a>
            <!-- Sign up -->
            <a class="btn btn-phoenix-primary order-0" href="authentication/simple/sign-up.html"><span
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-lg-6 text-lg-start text-center pt-8 pb-6 order-0 position-relative">
            ...
            <p class="mb-5">Standard, modern and Elegant solution for your next web app so you don’t have to
              ...
              class="btn btn-link me-2 fs-8 p-0" href="#!" role="button">Check Demo<span
                class="fa-solid fa-angle-right ms-2 fs-9"></span></a>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 mt-7 text-center text-lg-start">
              <div class="h-100 d-flex flex-column justify-content-between">
                <div class="border-start-lg border-translucent border-dashed ps-4"><img class="mb-4"
                    src="assets/img/icons/illustrations/bolt.png" width="48" height="48" alt="" />
                  <div>
                    <h5 class="fw-bolder mb-2">Lightning Speed</h5>
                    <p class="fw-semibold lh-sm">Present everything you need in one place within
                      minutes! Grow with Phoenix!</p>
                  </div>
                  <div><a class="btn btn-link me-2 p-0 fs-9" href="#!" role="button">Check Demo<span
              ...
              <div class="h-100 d-flex flex-column">
                <div class="border-start-lg border-translucent border-dashed ps-4"><img class="mb-4"
                  ...
                  <div>
                    ...
                    <p class="fw-semibold lh-sm">Show your production and growth graph in one place
                      with Phoenix!</p>
                  </div>
                  <div><a class="btn btn-link me-2 p-0 fs-9" href="#!" role="button">Check Demo<i
          ...
          <div
            ...
            <div class="col-lg-6">
              ...
              <p class="mb-4 px-md-7 px-lg-0">Grow with Phoenix. We help you with everything you might
                need., We make it easy and keep it simple.</p><a class="btn btn-link me-2 p-0 fs-9"
          ...
          <div
            ...
            <div class="col-lg-6 text-center text-lg-start">
              ...
              <p class="mb-4 px-md-7 px-lg-0">With Phoenix, you can get ready reports on your growth
                ...
                needs.</p><a class="btn btn-link me-2 p-0 fs-9" href="#!" role="button">Check Demo<i
                  class="fa-solid fa-angle-right ms-2"></i></a>
            </div>
          </div>
        </div>
    ...
    <div class="position-relative">
      ...
      <!--/.bg-holder-->
      <div class="bottom-0 start-0 end-0 bg-body-emphasis"><svg class="w-100" viewBox="0 0 1920 368" fill="none"
        ...
        <div class="container-small px-lg-7 px-xxl-3">
          <div class="row">
            <div class="col-lg-6 mb-6 text-center text-lg-start z-2">
              ...
              <h2 class="mb-3 text-body-emphasis">More than 2 Millions happy<br />Customers and counting
              </h2>
                  ...
                  <div class="carousel-item active">
                    <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                      <div class="col-lg-6 col-xl-5 text-center">
                        <div
                          ...
                          <img class="rounded-3 mb-lg-0 opacity-100 position-relative"
                            src="assets/img/team/61.webp" width="153" height="153" alt="" />
                        </div>
                      </div>
                      <div class="col-lg-6 col-xl-7 text-center text-lg-start">
                        ...
                        <h3 class="fs-7 fs-xl-6 mb-5 lh-sm me-md-7 me-lg-0">Brilliant app! Will
                    ...
                    <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                      <div class="col-lg-6 col-xl-5 text-center">
                        <div
                          ...
                          <!--/.bg-holder-->
                          <img class="rounded-3 mb-lg-0 opacity-100 position-relative"
                            src="assets/img/team/8.webp" width="154" alt="" />
                        </div>
                      </div>
                      <div class="col-lg-6 col-xl-7 text-center text-lg-start">
                        <div class="mb-4" data-bs-theme="light"><span
                            ...
                            class="fa fa-star text-primary"></span><span
                            class="fa fa-star text-primary"></span></div>
                        <h3 class="fs-7 fs-xl-6 mb-5 lh-sm me-md-7 me-lg-0">“Excellent to work
                    ...
                    <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                      <div class="col-lg-6 col-xl-5 text-center">
                        <div
                          ...
                          <!--/.bg-holder-->
                          <img class="rounded-3 mb-lg-0 opacity-100 position-relative"
                            src="assets/img/team/35.webp" width="154" alt="" />
                        </div>
                      </div>
                      <div class="col-lg-6 col-xl-7 text-center text-lg-start">
                        <div class="mb-4" data-bs-theme="light"><span
                            ...
                            class="fa fa-star text-primary"></span><span
                            class="fa fa-star text-primary"></span></div>
                        <h3 class="fs-7 fs-xl-6 mb-5 lh-sm me-md-7 me-lg-0">“Phoenix is all you
    ...
    <div class="position-relative">
          ...
          <div class="position-relative">
            <div class="row mb-6">
              <div class="col-xl-6 text-center text-md-start">
                ...
                <h1 class="fs-md-3 fs-xl-2 fw-black text-gradient-info text-uppercase mb-4 mb-md-0">
                  WORLDWIDE</h1>
              </div>
              <div class="col-xl-6 text-center text-md-start">
      ...
      </section><svg class="w-100 position-relative" viewBox="0 0 1920 368" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="bg-body-emphasis pb-lg-6 pb-xl-8">
      <div class="bg-holder d-dark-none"
        style="background-image:url(assets/img/bg/bg-5.png);background-size:auto;"></div>
      <!--/.bg-holder-->
      <div class="bg-holder d-light-none"
        style="background-image:url(assets/img/bg/bg-dark-5.png);background-size:auto;"></div>
      <!--/.bg-holder-->
      <div class="bg-holder"
      ...
      <div class="container-small position-relative px-lg-7 px-xxl-3">
        ...
        <p class="column-lg-2">Rise like Phoenix focusing only on functionalities for your digital products
          leaving the design for us. Show what you do, with our latest admin dashboard. Check our best works
          and let us know what you want to find. Want to tell your customers about the details of how and
          what? Tell them with all the posts at one place without them ridirecting to another page or site.
        </p>
        ...
        <div class="row g-3" id="image_gallery" style="min-height: 948px"
          ...
          <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item fourth"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/1.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/1.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/2.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/2.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/3.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/3.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/5.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/5.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third second"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/4.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/4.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/6.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/6.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/7.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/7.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-6 px-2 isotope-item second"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/9.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/9.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item fourth"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/8.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/8.png" alt="" /></a></div>
          <div class="col-6 col-md-4 col-lg-6 px-2 isotope-item second"><a href="#!"
              data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/10.png"><img
                class="rounded img-fluid w-100" src="assets/img/gallery/10.png" alt="" /></a></div>
        </div>
      </div>
    </section>
    <section class="bg-body-emphasis pt-lg-0 pt-xl-8">
      ...
      <div class="container-small position-relative px-lg-7 px-xxl-3">
        ...
        <p class="column-md-2 text-center text-sm-start">Entice your customers with Phoenix admin dashboard.
          Show your best deal in this section to help customers choose from your best offers and place them
          all in one place with this efficient template. If you are availing more than one offer to your
          customers, let them compare among them and search for what they need to get. Show offer details here
          and entice them to buy.</p>
            ...
            <div class="card h-100 rounded-end-xl-0 rounded-start">
              <div class="card-body px-6">
                <div class="px-5">
                  ...
                  <div class="text-center">
                    <h1 class="fw-semibold text-primary">$<span class="fw-bolder">6</span><span
                        class="text-body-emphasis fs-7 ms-1 fw-bolder">USD</span></h1>
                    <h5 class="mb-4 text-body"></h5><button
                ...
                <ul class="fa-ul pricing-list">
                  <li class="mb-4 d-flex align-items-center"><span class="fa-li"><span
                      ...
                      style="--phoenix-text-opacity:1;">Timeline</span></li>
                  <li class="mb-4 d-flex align-items-center"><span class="fa-li"><span
                        class="fas fa-check text-primary"></span></span><span
                  ...
                  <li class="mb-4 d-flex align-items-center"><span class="text-body-secondary"
                      style="--phoenix-text-opacity:.5;">Task dependencies</span></li>
                  <li class="mb-4 d-flex align-items-center"><span class="text-body-secondary"
                      style="--phoenix-text-opacity:.5;">Private teams &amp; projects</span></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="card h-100  rounded-top-0 rounded-xl-0 border border-2 border-primary mt-5 mt-md-0">
              ...
              <div class="card-body px-6">
                <div class="px-5">
                  ...
                  <div class="text-center">
                    <h1 class="fw-semibold text-primary">$<span class="fw-bolder">12</span><span
                        class="text-body-emphasis fs-7 ms-1 fw-bolder">USD</span></h1>
                    <h5 class="mb-4 text-body"></h5><button
                      class="btn btn-lg mb-6 w-100 btn-primary">Buy</button>
                  </div>
                </div>
                <ul class="fa-ul pricing-list">
                  <li class="mb-4 d-flex align-items-center"><span class="fa-li"><span
                  ...
                  <li class="mb-4 d-flex align-items-center"><span class="fa-li"><span
                      ...
                      fields</span><span
                      class="badge badge-phoenix badge-phoenix-warning ms-2 fs-10">New</span></li>
                  <li class="mb-4 d-flex align-items-center"><span class="text-body-secondary"
                      style="--phoenix-text-opacity:.5;">Task dependencies</span></li>
                  <li class="mb-4 d-flex align-items-center"><span class="text-body-secondary"
                      style="--phoenix-text-opacity:.5;">Private teams &amp; projects</span></li>
            ...
            <div class="card h-100 rounded-start rounded-start-xl-0 mt-5 mt-md-0">
              <div class="card-body px-6">
                <div class="px-5">
                  ...
                  <div class="text-center">
                    <h1 class="fw-semibold text-primary">$<span class="fw-bolder">23</span><span
                        class="text-body-emphasis fs-7 ms-1 fw-bolder">USD</span></h1>
                    <h5 class="mb-4 text-body"></h5><button
                      class="btn btn-lg mb-6 w-100 btn-outline-primary">Buy</button>
                  </div>
                  ...
                  <div class="card-body">
                    ...
                    <ul class="fa-ul pricing-list">
                      ...
                      <li class="mb-4 d-flex align-items-center"><span class="fa-li"><span
                            class="fas fa-check text-primary"></span></span><span
                          class="text-body-secondary"
                          style="--phoenix-text-opacity:1;">Advanced Search</span></li>
                      <li class="mb-4 d-flex align-items-center"><span class="fa-li"><span
                            class="fas fa-check text-primary"></span></span><span
                          class="text-body-secondary" style="--phoenix-text-opacity:1;">Custom
                          fields</span><span
    ...
    <section class="bg-body-emphasis" id="blog">
      <div class="container-small px-lg-7 px-xxl-3">
        ...
        <p class="column-md-2">See the latest articles we published with this dashboard. Your customers will be
          happy to find all the latest posts in one place. This menu efficiently shows all related topics from
          search filters and provides the customers with what they need. Also you can just educate your
          customers about everything they need to know and follow to avail a service with you. This menu is
          the one to show them that.</p>
        <div class="row h-100 g-3 justify-content-center">
          <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
            <div class="card text-white dark__text-gray-1100 h-100"><img
                class="rounded-top h-100 object-fit-cover" src="assets/img/blog/blog-1.png" alt="..." />
              <div class="card-body rounded-top">
                ...
                </h4><a class="btn-link px-0 d-flex align-items-center fs-9 fw-bold" href="#!"
          ...
          <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
            <div class="card text-white dark__text-gray-1100 h-100"><img
                class="rounded-top h-100 object-fit-cover" src="assets/img/blog/blog-2.png" alt="..." />
              <div class="card-body rounded-top">
                <div class="d-flex align-items-cente mb-3">
                  <div class="d-flex align-items-center me-3"><a
                      class="btn-link text-decoration-none d-flex align-items-center"
          ...
          <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
            <div class="card text-white dark__text-gray-1100 h-100"><img
                class="rounded-top h-100 object-fit-cover" src="assets/img/blog/blog-3.png" alt="..." />
              <div class="card-body rounded-top">
                <div class="d-flex align-items-cente mb-3">
                  <div class="d-flex align-items-center me-3"><a
                      class="btn-link text-decoration-none d-flex align-items-center"
          ...
          <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
            <div class="card text-white dark__text-gray-1100 h-100"><img
                class="rounded-top h-100 object-fit-cover" src="assets/img/blog/blog-4.png" alt="..." />
              <div class="card-body rounded-top">
                <div class="d-flex align-items-cente mb-3">
                  <div class="d-flex align-items-center me-3"><a
                      class="btn-link text-decoration-none d-flex align-items-center"
                ...
                <h4 class="fw-bold mb-3 lh-sm line-clamp-2">Best places for a tech job in U.S</h4><a
                  class="btn-link px-0 d-flex align-items-center fs-9 fw-bold" href="#!"
                  role="button">Read more<span class="fa-solid fa-angle-right ms-2"></span></a>
              </div>
            </div>
          </div>
    ...
    <section class="bg-body-emphasis">
      <div class="container-small px-lg-7 px-xxl-3">
        ...
        <p class="column-md-2">Do not lose your potential customers to others. Tell them exactly where you are
          with Geolocation enabled Phoenix admin dashboard, No need to take the burden of communicating
          directly. You can easily tell your customers where to find you with precise location map. Getting
        ...
        <div class="row g-5 g-lg-5">
            ...
            <div class="d-flex flex-column align-items-center align-items-md-start gap-3 gap-md-0">
              <div class="d-md-flex align-items-center">
                <div class="icon-wrapper shadow-info"><span
                    class="uil uil-phone text-primary fs-4 z-1 ms-2" data-bs-theme="light"></span>
                </div>
              ...
              <div class="mb-6 d-md-flex align-items-center">
                <div class="icon-wrapper shadow-info"><span
                    ...
                    data-bs-theme="light"></span></div>
                <div class="flex-1 ms-3"><a class="fw-semibold text-body" href="#!">39163 Amir Drive
                    Suite 802</a></div>
              </div>
              <div class="d-flex"><a href="#!"><span
                    class="fa-brands fa-facebook fs-6 text-primary me-3"></span></a><a
                  href="#!"><span class="fa-brands fa-twitter fs-6 text-primary me-3"></span></a><a
                  href="#!"><span class="fa-brands fa-linkedin-in fs-6 text-primary"></span></a></div>
            </div>
          </div>
          <div class="col-md-6 text-center text-md-start">
            ...
            <p class="mb-7">If you have any query or suggestion , we are open to learn from you, Lets talk,
              reach us anytime.</p>
            <form class="row g-4">
              <div class="col-12"><input class="form-control bg-body-emphasis" type="text" name="name"
                  placeholder="Name" required="required" /></div>
              <div class="col-12"><input class="form-control bg-body-emphasis" type="email" name="email"
                  placeholder="Email" required="required" /></div>
              <div class="col-12"><textarea class="form-control bg-body-emphasis" rows="6" name="message"
    ...
    <section id="team">
      ...
      <div class="position-absolute top-0 end-0 start-0"><svg class="w-100 text-white" preserveAspectRatio="none"
          viewBox="0 0 1920 368" xmlns="http://www.w3.org/2000/svg">
          <path class="fill-emphasis-bg" d="M1920 0.44L0 367.74V0H1920V0.44Z"></path>
        </svg></div>
      ...
      <div class="container-small position-relative py-1 px-lg-7 px-xxl-3" style="z-index:10">
        ...
        <p class="column-md-2 text-center text-sm-start">We have a small but strong development team to follow
          up on the development process. Reach out to us for further information. The team is ready to answer
          all your questions within minutes. The efficient team is always at your beck and call.</p>
    ...
    <div class="position-relative">
      ...
      <!--/.bg-holder-->
      <div class="position-relative"><svg class="w-100 text-white dark__text-gray-1100" preserveAspectRatio="none"
          ...
          <div class="container-small px-lg-7 px-xxl-3">
            <div class="row position-relative">
              <div class="col-12 col-sm-12 col-lg-5 mb-4 order-0 order-sm-0"><a href="#"><img class="mb-3"
                ...
                <p class="text-white opacity-50">All over the world. Alice in <br />wonderland and other
                  places.</p>
              </div>
              <div class="col-lg-7">
                  ...
                  <div class="col-6 col-sm-4 col-lg-3 mb-3 order-2 order-sm-1">
                    <div class="border-dashed border-start border-primary-light ps-3"
                      ...
                      <ul class="list-unstyled mb-3">
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">About</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Contact</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Developers</a></li>
                      </ul>
                    </div>
                    <div class="border-dashed border-start border-primary-light ps-3"
                      style="--phoenix-border-opacity: .2;">
                      ...
                      <ul class="list-unstyled mb-2">
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Facebook</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Twitter</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Linkedin</a></li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-6 col-sm-4 col-lg-3 mb-3 order-3 order-sm-2">
                    <div class="border-dashed border-start border-primary-light ps-3"
                      ...
                      <ul class="list-unstyled mb-md-2">
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Privacy</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Community</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Contact</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Blog</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">FAQ</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Project</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Team</a></li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-6 col-sm-4 col-lg-3 mb-3 order-3 order-sm-2">
                    <div class="border-dashed border-start border-primary-light ps-3"
                      ...
                      <ul class="list-unstyled mb-md-2">
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Personal</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">NFT System</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Agency</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">Contact</a></li>
                        <li class="mb-1"><a class="text-body-quaternary" href="#!"
                            data-bs-theme="light">About</a></li>
        ...
        <div class="row gx-2">
          ...
          <div class="col-6"><input class="btn-check" id="navbarPositionHorizontal" name="navigation-type"
              ...
              for="navbarPositionHorizontal"> <span class="rounded d-block"><img
                  class="img-fluid img-prototype d-dark-none" src="assets/img/generic/top-default.png"
          ...
          <div class="col-6"><input class="btn-check" id="navbarPositionTopDouble" name="navigation-type"
              ...
              for="navbarPositionTopDouble"> <span class="rounded d-block"><img
                  class="img-fluid img-prototype d-dark-none" src="assets/img/generic/dual-light.png"
                  alt="" /><img class="img-fluid img-prototype d-light-none"
