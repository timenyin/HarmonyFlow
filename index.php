...
<body style="--phoenix-scroll-margin-top: 1.2rem;">
    ...
    <main class="main" id="top">
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg-auto order-0 order-md-1 text-end order-1">
                        <div class="position-relative p-5 p-md-7 d-lg-none">
                            ...
                            <div class="position-relative">
                                <img class="w-100 shadow-lg d-dark-none rounded-2" src="assets/img/bg/bg-40.jpg"
                                    alt="hero-header" />
                                <img class="w-100 shadow-lg d-light-none rounded-2" src="assets/img/bg/bg-30.png"
                                    alt="hero-header" />
                            </div>
                        </div>
                        <div class="hero-image-container position-absolute top-0 bottom-0 end-0 d-none d-lg-block">
                            <div class="position-relative h-100 w-100">
                                ...
                                <div class="position-absolute h-100 top-0 d-flex align-items-center end-0">
                                    <!-- Hero Image  -->
                                    <img class="pt-7 pt-md-0 w-100 shadow-lg d-dark-none rounded-2 animated-border-image"
                                        src="assets/img/bg/bg-28.png" alt="hero-header" />
                                    <img class="pt-7 pt-md-0 w-100 shadow-lg d-light-none rounded-2 animated-border-image"
                                        src="assets/img/bg/bg-29.png" alt="hero-header" />
                                    <!-- End Hero Image  -->
                    ...
                    <div class="col-12 col-lg-6 text-lg-start text-center pt-8 pb-6 order-0 position-relative">
                        <h1 class="fs-3 fs-lg-2 fs-md-1 fs-lg-2 fs-xl-1 fs fw-black mb-4"><span
                                class="text-primary me-3">Webflow’s </span> Intelligent Hub
                        </h1>
                        <p class="mb-5">Streamline cross-department collaboration with audit-ready logs, role-based
                            access,
                            and AI-powered file organization.</p><a class="btn btn-lg btn-primary rounded-pill me-3"
                            href="#!" role="button">Sign up</a><a class="btn btn-link me-2 fs-8 p-0" href="#!"
                            role="button">Check Demo<span class="fa-solid fa-angle-right ms-2 fs-9"></span></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Features Section  -->
        <div class="py-5 pt-xl-13 bg-body-emphasis">
            <div class="container-small px-lg-7 px-xxl-3">
                <div class="mb-8 text-center text-sm-start">
                    <h4 class="text-primary fw-bolder mb-3">Features of NexusFlow</h4>
                    <h2>Organize <span class="fa-solid fa-circle fs-9 text-primary"></span> Automate
                        <span class="fa-solid fa-circle fs-9 text-primary"></span>
                        Collaborate
                    </h2>
                </div>
                <?php include('includes/public_features.php') ?>
            </div>
        </div>
