...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insert user with 2FA data
    $stmt = $pdo->prepare("
        INSERT INTO users (email, password_hash, name, twofa_code, twofa_expires)
        VALUES (?, ?, ?, ?, ?)
    ");
    ...
    if ($stmt->execute([$email, $hash, $name, $twofa_code, $twofa_expires])) {
        ...
        try {
            ...
            $mail->Subject = 'Your NexusFlow Verification Code';
            $mail->Body = "Your verification code: <strong>$twofa_code</strong><br>
                ...
                <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3"><a
                    ...
                    <div class="text-center mb-7">
                        ...
                        <p class="text-body-tertiary">Create your account today</p>
                            ...
                            class="fab fa-google text-danger me-2 fs-9"></span>Sign up with google</button><button
                    ...
                    <form>
                        ...
                        <div class="form-check mb-3"><input class="form-check-input" id="termsService"
                                ...
                                for="termsService">I accept the <a href="terms.php">terms </a>and <a href="#!">privacy
                                    policy</a></label></div><button class="btn btn-primary w-100 mb-3">Sign up</button>
                        <div class="text-center"><a class="fs-9 fw-bold" href="sign-in.php">Sign in to an existing
                                account</a></div>
                    </form>
                </div>
            </div>
